...
const productsRoute = async (req, res) => {
    if (req.url?.startsWith("/products")) {
        ...
        if (req.method === "GET" && !id) {
            ...
            res.end(JSON.stringify((0, item_1.getProducts)()));
            return;
        }
        // GET product by ID
        if (req.method === "GET" && id) {
            const product = (0, item_1.getProductById)(id);
        ...
        if (req.method === "POST" && !id) {
            ...
            req.on('end', () => {
                try {
                    ...
                    const newProduct = (0, item_1.addProduct)(name, size);
        ...
        if (req.method === "DELETE" && id) {
            const deleted = (0, item_1.deleteProduct)(id);
            if (deleted) {
                res.writeHead(200, { "content-type": "application/json" });
        ...
        if (req.method === "PATCH" && id) {
            ...
            req.on("end", () => {
                try {
                    ...
                    const updated = (0, item_1.updateProduct)(id, size);
                    if (updated) {
                        const product = (0, item_1.getProductById)(id); // Get updated product
                        res.writeHead(200, { "content-type": "application/json" });
